...
public class ChatPresenterImpl2 implements ChatPresenter {
    ...
    public void initChat(String contact) {
        ...
        if (conversation!=null){//1. 如果曾经有过会话，则最多获取20条历史聊天记录，然后放到集合中返回给View
            //先获取最近的一条聊天记录
